...
# you can untar https://mirrors.aliyun.com/homebrew/brew/tarball/master
# anywhere you like.
...
CHMOD=("/bin/chmod")
MKDIR=("/bin/mkdir" "-p")
HOMEBREW_BREW_DEFAULT_GIT_REMOTE="https://mirrors.aliyun.com/homebrew/brew"
HOMEBREW_CORE_DEFAULT_GIT_REMOTE="https://mirrors.aliyun.com/homebrew/homebrew-core"
...
REQUIRED_RUBY_VERSION=2.6    # https://mirrors.aliyun.com/homebrew/brew/pull/6556
...
# https://mirrors.aliyun.com/homebrew/brew/blob/master/Library/Homebrew/keg.rb
directories=(
...
echo "$(
  cat <<EOS
  ${tty_underline}https://mirrors.aliyun.com/homebrew/brew#donations${tty_reset}
EOS
)
"
