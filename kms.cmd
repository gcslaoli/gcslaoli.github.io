...
set KMSSER=kms.sltapp.cn
echo.
ping kms.sltapp.cn | find "超时"  > NUL &&  goto fail
ping kms.sltapp.cn | find "目标主机"  > NUL &&  goto fail
ping kms.sltapp.cn | find "无法访问"  > NUL &&  goto fail
ping kms.sltapp.cn | find "故障"  > NUL &&  goto fail
